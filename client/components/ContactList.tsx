...
import { CONTACT_LIST_PAGE_SIZE, MAX_NUMBER_OF_CONTACTS } from '../lib/constants';
      ...
      <div className={styles.center}>
        { hasMoreRecords ?
          <Button color={"violet"} onClick={handleLoadMoreRecords}>
            <ChevronDown />Load another {pageSize} contacts
          </Button> : <Notification color="red">No more records</Notification>
        }
      </div>
      <Paper shadow="xs" p="md">
        <Text size="sm" pb={20} color="blue">Displayed { offset * pageSize } records.</Text>
